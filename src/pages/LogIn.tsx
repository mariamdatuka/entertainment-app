    ...
    <section className='flex flex-col items-center justify-center gap-7 h-screen'>
      ...
      <main className='w-80 bg-[var(--color-semidark-blue)] p-4 rounded-md flex flex-col gap-2 items-start'>
           ...
           <form className='flex flex-col w-full gap-4 pt-4'>
              <input className='w-full border-b border-b-slate-400 bg-transparent py-3 placeholder:text-base  focus:outline-none' type='email'placeholder='Email Address'/>
              <input className='w-full border-b border-b-slate-400 bg-transparent py-3 placeholder:text-base focus:outline-none' type='password'placeholder='Password'/>
